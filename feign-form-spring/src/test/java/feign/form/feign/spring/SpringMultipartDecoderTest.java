...
class SpringMultipartDecoderTest {
  ...
  void downloadTest () throws Exception {
    ...
    assertThat(downloads.length)
      .isEqualTo(2);

    assertThat(downloads[0].getName())
      .isEqualTo("info");

    MediaType infoContentType = MediaType.parseMediaType(downloads[0].getContentType());
    assertThat(MediaType.TEXT_PLAIN.includes(infoContentType))
      .isTrue();
    assertThat(infoContentType.getCharset())
      .isNotNull();
    ...
    assertThat(downloads[1].getOriginalFilename())
      .isEqualTo("testfile.txt");
    assertThat(downloads[1].getContentType())
      .isEqualTo(MediaType.APPLICATION_OCTET_STREAM_VALUE);
    assertThat(downloads[1].getSize())
      .isEqualTo(14);
  }
}
