...
interface Client {
	...
	String upload1(@PathVariable("folder") String folder, @RequestPart("file") MultipartFile file,
			@RequestParam(name = "message", required = false) String message);

	@RequestMapping(value = "/multipart/upload2/{folder}", method = POST, consumes = MULTIPART_FORM_DATA_VALUE)
	String upload2(@RequestBody MultipartFile file, @PathVariable("folder") String folder,
			@RequestParam(name = "message", required = false) String message);
	...
	String upload4(@PathVariable("id") String id, @RequestBody Map<Object, Object> map,
