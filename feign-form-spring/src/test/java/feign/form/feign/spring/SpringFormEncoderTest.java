...
class SpringFormEncoderTest {
  ...
  void upload4Test () throws Exception {
    ...
    assertThat(client.upload4(id, map, userName))
      .isEqualTo(userName + ':' + id + ':' + map.size());
  }
  ...
  void upload6ArrayTest () throws Exception {
    ...
    assertThat(client.upload6Array(new MultipartFile[] { file1, file2 }))
  ...
  void upload6CollectionTest () throws Exception {
    ...
    assertThat(client.upload6Collection(list))
      .isEqualTo("Hello world");
  }
}
