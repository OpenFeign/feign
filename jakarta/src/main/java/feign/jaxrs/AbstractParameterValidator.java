...
abstract class AbstractParameterValidator<T> implements Predicate<Object> {
  public static final class DefaultParameterExpander extends AbstractParameterValidator<Void>
      implements Expander {
    @Override
  ...
  public boolean test(Object value) {
    ...
    if (clazz.isPrimitive()) {
      ...
      return true;
        ...
        && checkCollectionType((Collection<?>) value, allowedClass)) {
      return true;
    } else {
      return false;
    }
