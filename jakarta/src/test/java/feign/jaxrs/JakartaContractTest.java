 ...
 */
public class JakartaContractTest {

  private static final List<String> STRING_LIST = null;
  @Rule
  public final ExpectedException thrown = ExpectedException.none();
  JakartaContract contract = createContract();
  ...
  public void bodyParamIsGeneric() throws Exception {
    ...
    assertThat(md.bodyType())
        .isEqualTo(JakartaContractTest.class.getDeclaredField("STRING_LIST").getGenericType());
  }
