...
public class Server {
	...
	public ResponseEntity<Long> uploadWithDto(Dto dto, @RequestPart("file") MultipartFile file) throws IOException {
	...
	public ResponseEntity<String> uploadByteArrayParameter(MultipartHttpServletRequest request) {
		val status = request.getFile("file") == null && request.getParameter("file") != null ? OK : I_AM_A_TEAPOT;
