...
/**
 * Properly encodes requests with <b>application/x-www-form-urlencoded</b> and
 * <b>multipart/form-data</b> Content-Type.
 *
 * <p>Also, the encoder has a <b>delegate</b> field for encoding non-form requests (like JSON or
 * other).
 *
 * <p>Default <b>delegate</b> object is {@link feign.codec.Encoder.Default} instance.
 *
 * <p>Usage example:
 *
 * <p><b>Declaring API interface:</b>
 *
 * <pre>
 * interface SomeApi {
 *
 ...
 * </pre>
 *
 * <p><b>Creating Feign client instance:</b>
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>Now it can handle JSON Content-Type by {@code feign.jackson.JacksonEncoder} and form request
 * by {@link feign.form.FormEncoder}.
 *
...
public class FormEncoder implements Encoder {
   ...
   *
   * <p>Sets {@link feign.codec.Encoder.Default} instance as delegate encoder.
   */
  public FormEncoder() {
