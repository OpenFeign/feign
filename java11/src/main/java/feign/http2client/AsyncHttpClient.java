...
public class AsyncHttpClient extends AbstractHttpClient implements AsyncClient<Void> {
  ...
  @Override
  public CompletableFuture<Response> execute(Request request, Options options, Optional<Void> requestContext) {
