...
/**
 * Encodes an object into an HTTP request body. Like {@code javax.websocket.Encoder}. <br>
 ...
 * and passed to {@code Encoder.Text<Map<String, ?>>}. <br>
 *
 * <pre>
 * &#064;POST
 * &#064;Path(&quot;/&quot;)
...
public interface Encoder<T> {
  ...
  interface Text<T> extends Encoder<T> {
    /**
     * Implement this to encode an object as a String.. If you need to wrap exceptions, please do so
     * via {@link EncodeException}
     *
     * @param object what to encode as the request body.
     * @return the encoded object as a string. * @throws EncodeException when encoding failed due to
     *     a checked exception.
     */
