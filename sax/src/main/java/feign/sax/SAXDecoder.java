 ...
 * </pre>
 * <p/> <h4>Advanced example with Dagger</h4> <br>
 * <pre>
 * &#064;Provides
...
public class SAXDecoder implements Decoder {
  ...
  public Object decode(Response response, Type type) throws IOException, DecodeException {
    ...
    checkState(handlerProvider != null, "type %s not in configured handlers %s", type,
  ...
  public static class Builder {
     ...
     */
    public Builder registerContentHandler(Type type,
                                          Provider<? extends ContentHandlerWithResult<?>> handler) {
