  ...
  public static Object[][] errorCodes() {
    return new Object[][] {
        {400, FeignException.BadRequest.class,
            "[400 anything] during [GET] to [http://example.com/api]: [response body]"},
        {401, FeignException.Unauthorized.class,
            "[401 anything] during [GET] to [http://example.com/api]: [response body]"},
        {403, FeignException.Forbidden.class,
            "[403 anything] during [GET] to [http://example.com/api]: [response body]"},
        {404, FeignException.NotFound.class,
            "[404 anything] during [GET] to [http://example.com/api]: [response body]"},
        {405, FeignException.MethodNotAllowed.class,
            "[405 anything] during [GET] to [http://example.com/api]: [response body]"},
        {406, FeignException.NotAcceptable.class,
            "[406 anything] during [GET] to [http://example.com/api]: [response body]"},
        {409, FeignException.Conflict.class,
            "[409 anything] during [GET] to [http://example.com/api]: [response body]"},
        {429, FeignException.TooManyRequests.class,
            "[429 anything] during [GET] to [http://example.com/api]: [response body]"},
        {422, FeignException.UnprocessableEntity.class,
            "[422 anything] during [GET] to [http://example.com/api]: [response body]"},
        {450, FeignException.FeignClientException.class,
            "[450 anything] during [GET] to [http://example.com/api]: [response body]"},
        {500, FeignException.InternalServerError.class,
            "[500 anything] during [GET] to [http://example.com/api]: [response body]"},
        {501, FeignException.NotImplemented.class,
            "[501 anything] during [GET] to [http://example.com/api]: [response body]"},
        {502, FeignException.BadGateway.class,
            "[502 anything] during [GET] to [http://example.com/api]: [response body]"},
        {503, FeignException.ServiceUnavailable.class,
            "[503 anything] during [GET] to [http://example.com/api]: [response body]"},
        {504, FeignException.GatewayTimeout.class,
            "[504 anything] during [GET] to [http://example.com/api]: [response body]"},
        {599, FeignException.FeignServerException.class,
            "[599 anything] during [GET] to [http://example.com/api]: [response body]"},
