...
public class DefaultContractTest {
  ...
  public void pathAndQueryParamsAnnotatedWithNamed() throws Exception {
    MethodMetadata md = parseAndValidateMetadata(WithPathAndQueryParamsAnnotatedWithNamed.class,
  ...
  public void bodyWithTemplateAnnotatedWithNamed() throws Exception {
      MethodMetadata md = parseAndValidateMetadata(FormParamsAnnotatedWithNamed.class,
          "login", String.class, String.class, String.class);
  ...
  public void headerParamsAnnotatedWithNamedParseIntoIndexToName() throws Exception {
    MethodMetadata md = parseAndValidateMetadata(HeaderParamsAnnotatedWithNamed.class,
                                                "logout", String.class);
