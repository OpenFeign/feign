...
public class JSONTokener {
   ...
   * 
   * @throws JSONException Thrown if trying to step back more than 1 step or if already at the start
   *         of the string
   */
   ...
   * @throws JSONException thrown if there is an error stepping forward or backward while checking
   *         for more data.
   */
