 ...
 *
 * <ol>
 *   <li>unresolved variables are preserved as literals
 *   <li>all literals are pct-encoded
 * </ol>
 */
public class UriTemplate extends Template {
  ...
  public static UriTemplate append(UriTemplate uriTemplate, String fragment) {
    return new UriTemplate(
        uriTemplate.toString() + fragment, uriTemplate.encodeSlash(), uriTemplate.getCharset());
  }
