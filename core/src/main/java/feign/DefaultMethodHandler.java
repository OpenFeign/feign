...
final class DefaultMethodHandler implements MethodHandler {
    ...
    public DefaultMethodHandler(Method defaultMethod) {
        ...
        try {
            if (System.getProperty("java.vm.name").equalsIgnoreCase("Dalvik")) {
                androidObtainHandle(defaultMethod, declaringClass);
            } else {
    ...
    public void androidObtainHandle(Method defaultMethod, Class<?> declaringClass) throws InstantiationException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        try {
