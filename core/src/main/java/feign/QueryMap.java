 ...
 * parameter map as a variable. <br> <br>
 * <pre>
 * ...
 ...
 * void get(&#64;Param("serverId") String serverId, &#64;Param("count") int count, &#64;QueryMap
 * Map<String, Object>);
 * ...
 * </pre>
 ...
 * <br> <br> <ul> <li>if the value is null, the value will remain null (rather than converting to
 * the String "null") <li>if the value is an {@link Iterable}, it is converted to a {@link List} of
 * String objects where each value in the list is either null if the original value was null or the
 * value's toString representation otherwise. </ul> <br> Once this conversion is applied, the query
 * keys and resulting String values follow the same contract as if they were set using {@link
