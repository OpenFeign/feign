 ...
 * <br>
 * {@code RequestInterceptors} are configured via Dagger {@link dagger.Provides.Type#SET set} or
 * {@link dagger.Provides.Type#SET_VALUES set values} {@link dagger.Provides provider} methods. <br>
 * <br>
 * For example: <br>
 *
 * <pre>
