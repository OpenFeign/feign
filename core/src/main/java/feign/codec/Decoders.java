...
public class Decoders {
   ...
   * shortcut for
   *
   * <pre>new TransformFirstGroup<String>(pattern, applyFirstGroup){}</pre>
   *
   * when {@code String} is the type you are decoding into. <br>
   * <br>
   ...
   * shortcut for
   *
   * <pre>new TransformEachFirstGroup<String>(pattern, applyFirstGroup){}</pre>
   *
   * when {@code List<String>} is the type you are decoding into. <br>
  ...
  public static class TransformFirstGroup<T> implements Decoder.TextStream<T> {
    ...
    /**
     * You must subclass this, in order to prevent type erasure on {@code T} . In addition to making
     * a concrete type, you can also use the following form.
     *
     * <p><br>
     *
     * <p>
