...
public class MockClient implements Client {
  ...
  private Response.Builder getResponseBuilder(Request request, RequestKey requestKey) {
    ...
    if (responseBuilder == null) {
      responseBuilder = Response.builder().status(HttpURLConnection.HTTP_NOT_FOUND)
          .reason("Not mocker")
  ...
  /**
   * @param response <ul> <li>the status defaults to 0, not 200!</li> <li>the internal feign-code
   * requires the headers to be set</li> </ul>
   */
