...
public class JAXRSContractTest extends JAXRSContractTestSupport<JAXRSContract> {
	...
	protected interface WithMatrixParam {
	...
	protected interface WithPathAndDefaultQueryParams {

		@GET
		@Path("/domains/{domainId}/records")
		Response recordsByNameAndType(@PathParam("domainId") int id,
				@DefaultValue("defaultName") @QueryParam("name") String nameFilter,
				@DefaultValue("defaultType") @QueryParam("type") String typeFilter);

	}

	protected interface WithDefaultPathParam {

		@GET
		@Path("/domains/{name}/records")
		Response recordsByName(@DefaultValue("defaultDomainName") @PathParam("name") String domainName);
	}

	protected interface WithDefaultFormParam {

		@POST
		void login(@DefaultValue("netflix") @FormParam("customer_name") String customer,
				@DefaultValue("denominator") @FormParam("user_name") String user,
				@DefaultValue("password") @FormParam("password") String password);
	}

	protected interface WithDefaultHeaderParam {

		@POST
		void logout(@DefaultValue("defaultToken") @HeaderParam("Auth-Token") String token);
	}
	...
	protected Class<?> withPathAndDefaultQueryParamsClass() {
		return WithPathAndDefaultQueryParams.class;
	}

	@Override
	protected Class<?> withDefaultPathParamClass() {
		return WithDefaultPathParam.class;
	}

	@Override
	protected Class<?> withDefaultFormParamClass() {
		return WithDefaultFormParam.class;
	}

	@Override
	protected Class<?> withDefaultHeaderParamClass() {
		return WithDefaultHeaderParam.class;
	}
