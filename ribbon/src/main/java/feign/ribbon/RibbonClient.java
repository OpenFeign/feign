...
public class RibbonClient implements Client {
  ...
  public final static class Builder {
    ...
    private Client delegate = new Client.Default(null, null);
    private LBClientFactory lbClientFactory = new LBClientFactory.Default();
    ...
    public RibbonClient build() {
      return new RibbonClient(delegate, lbClientFactory);
    }
